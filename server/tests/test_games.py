...
class TestGamesRoutes(unittest.TestCase):
    ...
    def test_create_game_success(self) -> None:
        ...
        new_game_data = {
            "title": "Code Quest",
            "description": "An epic journey through the world of programming",
            "category_id": 1,
            "publisher_id": 1,
            "star_rating": 4.8
        }
    ...
    def test_create_game_invalid_category(self) -> None:
        ...
        invalid_game_data = {
            "title": "Invalid Game",
            "description": "This game has an invalid category",
            "category_id": 999,
            "publisher_id": 1,
            "star_rating": 4.0
        }
    ...
    def test_create_game_invalid_publisher(self) -> None:
        ...
        invalid_game_data = {
            "title": "Invalid Game",
            "description": "This game has an invalid publisher",
            "category_id": 1,
            "publisher_id": 999,
            "star_rating": 4.0
        }
    ...
    def test_create_game_invalid_title(self) -> None:
        ...
        invalid_game_data = {
            "title": "A",
            "description": "This game has a title that is too short",
            "category_id": 1,
            "publisher_id": 1,
            "star_rating": 4.0
        }
