...
def seed_database():
    """
    Main function to seed the database with initial game data.
    
    Creates games, publishers, and categories from CSV data and
    populates the database for the crowdfunding platform.
    """
    create_games()
